...
//GHG Emissions Constraint    	 
	forall(y in Years: y>1)
	  {
		GHG_emissions:
	  	  (CO2_total[y]+CH4_total[y]*25+N2O_total[y]*298) <= (CO2_total[y-1]+CH4_total[y-1]*25+N2O_total[y-1]*298) * 0.96401; //ends in the final year as 25% of the original amount (75% decrease)  	  
      }	
